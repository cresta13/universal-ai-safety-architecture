...
UAIS is a pre-standard research architecture. Its limits are part of the public review scope.

## Specification maturity limitations

- Draft Candidate status;
- some metrics still require calibration;
...
- complete Reachable Future Authority bounds;
...
- hostile post-sovereignty containment;
- international interoperability without central authority;
- safe machine-speed legitimacy;
- intervention/reversibility modeling.
