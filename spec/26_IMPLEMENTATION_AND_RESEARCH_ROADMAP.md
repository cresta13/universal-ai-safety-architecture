...
Causal HHR, coalition/CPE simulation, Guardian diversity/evaluation, privacy-preserving attestation, metric calibration, offline replication budgets, authority gradient forecasting, intervention/reversibility models, PhysicalSovereigntyMargin estimator.

## Standards and governance

Vocabulary/classification consensus; test-lab accreditation; SAL floors; protocol schemas; liability and disclosure rules; Constitution amendment; federated trust; consumer communication tests; incident taxonomy.

## Long-horizon Stage II
